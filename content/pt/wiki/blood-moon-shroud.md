...
Patch notes oficiais citam explicitamente versões Blood Moon de **Rotting Oni** e **Booze Brute**, e posteriormente adicionaram um aviso quando **Zombie Siege** se sobrepõe a Blood Moon Shroud.

## O que muda durante Blood Moon
...
Notas oficiais de outubro de 2025 adicionaram uma confirmação secundária quando **Zombie Siege** entra em conflito com **Blood Moon Shroud**.

Operacionalmente, a liderança da aliança não deve assumir que os dois eventos podem ser executados ao mesmo tempo sem coordenação. Se houver sobreposição, pode ser necessário anunciar uma prioridade clara.

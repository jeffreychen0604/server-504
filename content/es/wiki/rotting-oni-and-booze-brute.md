...
- reducción del CP recomendado para Rotting Onis Lv.1–65;
- reducción del CP recomendado para Booze Brutes Lv.1–65;
- reducción de Viral Resistance para **Blood Moon Rotting Onis** Lv.65+;
- reducción de Viral Resistance para **Blood Moon Booze Brutes** Lv.65+.

Esto demuestra que tablas antiguas de CP/resistencia pueden quedar obsoletas incluso dentro de la misma temporada.
...
No evalúes estos monstruos solo por CP recomendado. Un jugador con suficiente CP bruto pero poca Virus Resistance puede seguir rindiendo mal.

Orden útil de comprobación:

1. Virus Resistance;
2. fuerza actual de la formación;
3. nivel/versión del objetivo;
4. normal o Blood Moon;
5. objetivo pensado para solo o rally.

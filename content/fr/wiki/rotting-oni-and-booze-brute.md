...
Booze Brute est présenté comme une cible plus importante, orientée **rally**. La participation de l’alliance compte donc davantage que la puissance isolée d’un joueur.

## Historique officiel d’équilibrage

La mise à jour de novembre 2025 confirme :

- baisse du CP recommandé des Rotting Onis Lv.1–65 ;
- baisse du CP recommandé des Booze Brutes Lv.1–65 ;
- baisse de la Viral Resistance requise pour les **Blood Moon Rotting Onis** Lv.65+ ;
- baisse de la Viral Resistance requise pour les **Blood Moon Booze Brutes** Lv.65+.

Les anciens tableaux CP/résistance peuvent donc devenir obsolètes même au cours d’une même saison.
...
Ne jugez pas ces monstres uniquement par le CP recommandé. Une formation puissante avec trop peu de Virus Resistance peut rester inefficace.

Ordre de vérification utile :

1. Virus Resistance ;
2. puissance actuelle de la formation ;
3. niveau/version de la cible ;
4. version normale ou Blood Moon ;
5. cible prévue pour solo ou rally.
...
- Apple App Store version history — official Rotting Oni / Booze Brute balance changes: https://apps.apple.com/app/dark-war-survival/id6670441558
